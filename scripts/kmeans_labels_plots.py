...
#plot labels as a function of time, current, energy, etc
#reload dfs since we deleted some of these earlier
...
axs[0].plot(df003['Num Zero Crossings'],q003_labels,'.r',markersize=s)    
axs[0].set_ylabel('q003 labels')
axs[1].plot(df103['Num Zero Crossings'],q103_labels,'.b',markersize=s)  
axs[1].set_ylabel('q103 labels')
axs[0].set_xlim([0,5000])
axs[1].set_xlim([0,5000])
axs[0].set_title('Num Zero Crossings')

# ['Num Zero Crossings']/'Umax^2']
fig, axs = plt.subplots(2, 1)
axs[0].plot(ratio_umax_003, q003_labels,'.r',markersize=s)    
axs[0].set_ylabel('q003 labels')
axs[1].plot(ratio_umax_103, q103_labels,'.b',markersize=s)  
axs[1].set_ylabel('q103 labels')
axs[0].set_xlim([0,50000])
axs[1].set_xlim([0,50000])
axs[0].set_title('Num Zero Crossings/Umax^2')

# ['Duration (pts)']
fig, axs = plt.subplots(2, 1)
axs[0].plot(df003['Duration (pts)'],q003_labels,'.r',markersize=s)    
axs[0].set_ylabel('q003 labels')
axs[1].plot(df103['Duration (pts)'],q103_labels,'.b',markersize=s)  
axs[1].set_ylabel('q103 labels')
axs[0].set_xlim([0,50000])
axs[1].set_xlim([0,50000])
axs[0].set_title('Duration (pts)')

# ['Umax^2'] 
fig, axs = plt.subplots(2, 1)
axs[0].plot(df003['Umax^2'],q003_labels,'.r',markersize=s)    
axs[0].set_ylabel('q003 labels')
axs[1].plot(df103['Umax^2'],q103_labels,'.b',markersize=s)  
axs[1].set_ylabel('q103 labels')
axs[0].set_xlim([0,1.5])
axs[1].set_xlim([0,1.5])
axs[0].set_title('Umax^2')

# ['Urms^2'] 
fig, axs = plt.subplots(2, 1)
axs[0].plot(df003['Urms^2'],q003_labels,'.r',markersize=s)    
axs[0].set_ylabel('q003 labels')
axs[1].plot(df103['Urms^2'],q103_labels,'.b',markersize=s)  
axs[1].set_ylabel('q103 labels')
axs[0].set_xlim([0,0.05])
axs[1].set_xlim([0,0.05])
axs[0].set_title('Urms^2')

# ['Mag Current (A)'] #broken for quench 3
fig, axs = plt.subplots(2, 1)
axs[0].plot(df003['Mag Current (A)'],q003_labels,'.r',markersize=s)    
axs[0].set_ylabel('q003 labels')
axs[1].plot(df103['Mag Current (A)'],q103_labels,'.b',markersize=s)  
axs[1].set_ylabel('q103 labels')
axs[0].set_title('Mag Current (A)')

# ['Abs Start Point'] 
fig, axs = plt.subplots(2, 1)
axs[0].plot(df003['Abs Start Point'],q003_labels,'.r',markersize=s)    
axs[0].set_ylabel('q003 labels')
axs[1].plot(df103['Abs Start Point'],q103_labels,'.b',markersize=s)  
axs[1].set_ylabel('q103 labels')
axs[0].set_title('Abs Start Point')
